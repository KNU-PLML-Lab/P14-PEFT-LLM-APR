...
def fine_tune(training_file, validation_file, epochs, batch_size, save_dir, parallel=False, load_range=None):
    tokenizer = AutoTokenizer.from_pretrained(vocabulary_file, device_map="auto")
...
if __name__ == '__main__':
    device_ids = [0, 1, 2, 3]
    training_file = '/home/yglee/wl/p14/data/finetune_training.jsonl'      # change to fine-tuning data path
    validation_file = '/home/yglee/wl/p14/data/finetune_validation.jsonl'    # change to fine-tuning data path
    vocabulary_file = '/home/yglee/WorkspaceLabModels/codegen_6b/'
    pretrained_file = '/home/yglee/WorkspaceLabModels/codegen_6b/'

    fine_tune(
        training_file, validation_file, epochs=1, batch_size=1, save_dir='/home/yglee/WorkspaceLabModels/codegen-6B-finetune', 
        parallel=True, load_range=None
    )
